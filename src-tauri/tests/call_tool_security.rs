...
fn dangerous_command_requires_explicit_confirmation() {
    let policy = coding_tools_mcp::tools::policy::PolicySettings::default();
    let accepted = coding_tools_mcp::tools::policy::validate_tool_arguments(
        "exec_command",
...
fn destructive_command_targeting_git_is_always_rejected() {
    let policy = coding_tools_mcp::tools::policy::PolicySettings::default();
    let error = coding_tools_mcp::tools::policy::validate_tool_arguments(
        "exec_command",
...
fn exec_command_allows_python_c_but_rejects_shell_escape() {
    let policy = coding_tools_mcp::tools::policy::PolicySettings::default();
    assert!(coding_tools_mcp::tools::policy::validate_tool_arguments(
        "exec_command",
...
fn safe_permission_mode_blocks_network_looking_command() {
    let policy = coding_tools_mcp::tools::policy::PolicySettings {
        permission_mode: "safe".into(),
        ..Default::default()
    };
    let err = coding_tools_mcp::tools::policy::validate_tool_arguments(
        "exec_command",
