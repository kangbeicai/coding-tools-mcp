...
use crate::gateway::{
    gateway_exposure_status, gateway_status, get_gateway_config as get_gateway_config_service,
    get_gateway_exposure_config, restart_gateway_service,
    set_gateway_config as set_gateway_config_service, set_gateway_exposure_config,
    start_gateway_exposure_service, start_gateway_service, stop_gateway_exposure_service,
    stop_gateway_service, GatewayExposureStatusDto, GatewayStatusDto,
};
use crate::health::{
    run_gateway_health_checks as execute_gateway_health_checks, GatewayHealthReport,
};
...
#[tauri::command]
pub fn get_gateway_exposure(state: State<'_, AppState>) -> AppResult<GatewayExposureConfig> {
